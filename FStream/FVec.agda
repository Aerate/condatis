...
data FVec {ℓ₁ ℓ₂ ℓ₃} (C : Container ℓ₁ ℓ₂) (A : Set ℓ₃) : (n : ℕ) → Set (ℓ₁ ⊔ ℓ₂ ⊔ ℓ₃) where
  FNil : FVec C A 0
...
_⟩ : ∀ {ℓ₁ ℓ₂ ℓ₃} {C : Container ℓ₁ ℓ₂} {A : Set ℓ₃} → ⟦ C ⟧ A → FVec C A 1
a ⟩ = a ▻ FNil

mutual
  vmap : ∀ {ℓ₁ ℓ₂ ℓ₃} {C : Container ℓ₁ ℓ₂} {A : Set ℓ₃} {B : Set ℓ₃} {n} →
...
mutual
  take : ∀ {ℓ₁ ℓ₂ ℓ₃} {C : Container ℓ₁ ℓ₂} {A : Set ℓ₃} →
...
_pre⟨_▻⋯' : ∀ {i ℓ₁ ℓ₂ ℓ₃} {C : Container ℓ₁ ℓ₂} {A : Set ℓ₃} {m n}
...
⟨_▻⋯' : ∀ {i ℓ₁ ℓ₂ ℓ₃} {C : Container ℓ₁ ℓ₂} {A : Set ℓ₃} {n : ℕ}
...
mutual
  ...
  _aux_ : ∀ {i ℓ₁ ℓ₂ ℓ₃} {C : Container ℓ₁ ℓ₂} {A : Set ℓ₃} {n m : ℕ}
...
data _[_]=_ {ℓ₁ ℓ₂ ℓ₃} {A : Set ℓ₁} {C : Container ℓ₂ ℓ₃} : {n : ℕ} → FVec C A n → Fin n → ⟦ C ⟧ A → Set (ℓ₁ ⊔ ℓ₂ ⊔ ℓ₃) where
